...
var data__$1 = (cljs.core.truth_((function (){var and__4221__auto__ = transform;
...
if((!((ident == null)))){
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4((function (){var G__59085 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(query,cljs.core.first(ident));
var G__59086 = data__$1;
var G__59087 = refs;
var G__59088 = union_seen;
var G__59089 = transform;
return (com.fulcrologic.fulcro.algorithms.normalize.normalize_STAR_.cljs$core$IFn$_invoke$arity$5 ? com.fulcrologic.fulcro.algorithms.normalize.normalize_STAR_.cljs$core$IFn$_invoke$arity$5(G__59085,G__59086,G__59087,G__59088,G__59089) : com.fulcrologic.fulcro.algorithms.normalize.normalize_STAR_.call(null,G__59085,G__59086,G__59087,G__59088,G__59089));
...
var vec__59127 = com.fulcrologic.fulcro.algorithms.do_not_use.join_entry(expr);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59127,(0),null);
var sel = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59127,(1),null);
...
var G__59162 = cljs.core.next(q);
var G__59163 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,k,i);
q = G__59162;
ret = G__59163;
continue;
} else {
var G__59164 = cljs.core.next(q);
var G__59165 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,k,x);
q = G__59164;
ret = G__59165;
continue;
}
...
var xs = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(((function (q,ret,vec__59127,k,sel,recursive_QMARK_,union_entry,sel__$1,class$,v,expr,data__$1){
return (function (p1__59083_SHARP_){
return (com.fulcrologic.fulcro.algorithms.normalize.normalize_STAR_.cljs$core$IFn$_invoke$arity$5 ? com.fulcrologic.fulcro.algorithms.normalize.normalize_STAR_.cljs$core$IFn$_invoke$arity$5(sel__$1,p1__59083_SHARP_,refs,union_entry,transform) : com.fulcrologic.fulcro.algorithms.normalize.normalize_STAR_.call(null,sel__$1,p1__59083_SHARP_,refs,union_entry,transform));
});})(q,ret,vec__59127,k,sel,recursive_QMARK_,union_entry,sel__$1,class$,v,expr,data__$1))
),v);
if((!((((class$ == null)) || ((!(com.fulcrologic.fulcro.components.has_ident_QMARK_(class$)))))))){
var is = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(((function (q,ret,xs,vec__59127,k,sel,recursive_QMARK_,union_entry,sel__$1,class$,v,expr,data__$1){
return (function (p1__59084_SHARP_){
return (com.fulcrologic.fulcro.components.get_ident.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.components.get_ident.cljs$core$IFn$_invoke$arity$2(class$,p1__59084_SHARP_) : com.fulcrologic.fulcro.components.get_ident.call(null,class$,p1__59084_SHARP_));
});})(q,ret,xs,vec__59127,k,sel,recursive_QMARK_,union_entry,sel__$1,class$,v,expr,data__$1))
),xs);
if(cljs.core.vector_QMARK_(sel__$1)){
if(cljs.core.empty_QMARK_(is)){
} else {
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(refs,((function (q,ret,is,xs,vec__59127,k,sel,recursive_QMARK_,union_entry,sel__$1,class$,v,expr,data__$1){
return (function (refs__$1){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (q,ret,is,xs,vec__59127,k,sel,recursive_QMARK_,union_entry,sel__$1,class$,v,expr,data__$1){
return (function (m,p__59135){
var vec__59136 = p__59135;
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59136,(0),null);
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59136,(1),null);
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$4(m,i,cljs.core.merge,x);
});})(q,ret,is,xs,vec__59127,k,sel,recursive_QMARK_,union_entry,sel__$1,class$,v,expr,data__$1))
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (q,ret,is,xs,vec__59127,k,sel,recursive_QMARK_,union_entry,sel__$1,class$,v,expr,data__$1){
return (function (ret__$1,p__59139){
var vec__59140 = p__59139;
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59140,(0),null);
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59140,(1),null);
...
var G__59169 = cljs.core.next(q);
var G__59170 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,k,is);
q = G__59169;
ret = G__59170;
continue;
} else {
var G__59171 = cljs.core.next(q);
var G__59172 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,k,xs);
q = G__59171;
ret = G__59172;
continue;
}
...
if((v == null)){
var G__59173 = cljs.core.next(q);
var G__59174 = ret;
q = G__59173;
ret = G__59174;
continue;
} else {
var G__59175 = cljs.core.next(q);
var G__59176 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,k,v);
q = G__59175;
ret = G__59176;
continue;
...
var v = cljs.core.get.cljs$core$IFn$_invoke$arity$2(data__$1,k);
if((v == null)){
var G__59177 = cljs.core.next(q);
var G__59178 = ret;
q = G__59177;
ret = G__59178;
continue;
} else {
var G__59179 = cljs.core.next(q);
var G__59180 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,k,v);
q = G__59179;
ret = G__59180;
continue;
}
