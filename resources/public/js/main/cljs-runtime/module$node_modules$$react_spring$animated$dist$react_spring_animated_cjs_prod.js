shadow$provide.module$node_modules$$react_spring$animated$dist$react_spring_animated_cjs_prod=function(global,require,module,exports){function makeAnimated(value){return(shared.isAnimatedString(value)?AnimatedString:AnimatedValue).create(value)}function _extends(){_extends=Object.assign||function(target){for(var i=1;i<arguments.length;i++){var source=arguments[i],key;for(key in source)Object.prototype.hasOwnProperty.call(source,key)&&(target[key]=source[key])}return target};return _extends.apply(this,
arguments)}function getAnimatedState(props,host){const dependencies=new Set;JSCompiler_object_inline_dependencies_1921=dependencies;props.style&&(props=_extends({},props,{style:host.createAnimatedStyle(props.style)}));props=new AnimatedObject(props);JSCompiler_object_inline_dependencies_1921=null;return[props,dependencies]}Object.defineProperty(exports,"__esModule",{value:!0});var shared=require("module$node_modules$$react_spring$shared$dist$react_spring_shared_cjs"),React=require("module$node_modules$react$index"),
...
value},[givenRef]),[props,deps]=getAnimatedState(givenProps,host),forceUpdate=shared.useForceUpdate();givenProps=()=>{const instance=instanceRef.current;hasInstance&&!instance||!1!==(instance?host.applyAnimatedValues(instance,props.getValue(!0)):!1)||forceUpdate()};const observer$jscomp$0=new PropsObserver(givenProps,deps),observerRef=React.useRef();shared.useLayoutEffect(()=>{const lastObserver=observerRef.current;observerRef.current=observer$jscomp$0;shared.each(deps,dep=>shared.addFluidObserver(dep,
observer$jscomp$0));lastObserver&&(shared.each(lastObserver.deps,dep=>shared.removeFluidObserver(dep,lastObserver)),shared.raf.cancel(lastObserver.update))});React.useEffect(givenProps,[]);shared.useOnce(()=>()=>{const observer=observerRef.current;shared.each(observer.deps,dep=>shared.removeFluidObserver(dep,observer))});givenProps=host.getComponentProps(props.getValue());return React__namespace.createElement(Component,_extends({},givenProps,{ref}))})};class PropsObserver{constructor(update,deps){this.update=
update;this.deps=deps}eventObserved(event){"change"==event.type&&shared.raf.write(this.update)}}const cacheKey=Symbol.for("AnimatedComponent"),getDisplayName=arg=>shared.is.str(arg)?arg:arg&&shared.is.str(arg.displayName)?arg.displayName:shared.is.fun(arg)&&arg.name||null;exports.Animated=Animated;exports.AnimatedArray=AnimatedArray;exports.AnimatedObject=AnimatedObject;exports.AnimatedString=AnimatedString;exports.AnimatedValue=AnimatedValue;exports.createHost=(components,{applyAnimatedValues:_applyAnimatedValues=
...
//# sourceMappingURL=module$node_modules$$react_spring$animated$dist$react_spring_animated_cjs_prod.js.map
