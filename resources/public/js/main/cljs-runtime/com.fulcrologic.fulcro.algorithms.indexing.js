...
com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_ = (function com$fulcrologic$fulcro$algorithms$indexing$index_query_STAR_(prop__GT_classes,p__61782){
var map__61783 = p__61782;
var map__61783__$1 = cljs.core.__destructure_map(map__61783);
var ast = map__61783__$1;
var parent_component = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61783__$1,new cljs.core.Keyword(null,"component","component",1555936782));
var parent_children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61783__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (idx,p__61790){
var map__61791 = p__61790;
var map__61791__$1 = cljs.core.__destructure_map(map__61791);
var child_ast = map__61791__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61791__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var dispatch_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61791__$1,new cljs.core.Keyword(null,"dispatch-key","dispatch-key",733619510));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61791__$1,new cljs.core.Keyword(null,"children","children",-940561982));
var G__61792 = idx;
var G__61792__$1 = ((((cljs.core.vector_QMARK_(key)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),cljs.core.second(key)))))?update_index(G__61792,dispatch_key,parent_key):G__61792);
var G__61792__$2 = ((((cljs.core.vector_QMARK_(key)) && (cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),cljs.core.second(key)))))?update_index(G__61792__$1,key,parent_key):G__61792__$1);
var G__61792__$3 = (((key instanceof cljs.core.Keyword))?update_index(G__61792__$2,key,parent_key):G__61792__$2);
if(cljs.core.seq(children)){
return (com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_.cljs$core$IFn$_invoke$arity$2(G__61792__$3,child_ast) : com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_.call(null,G__61792__$3,child_ast));
} else {
return G__61792__$3;
}
...
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61804__$1,new cljs.core.Keyword(null,"children","children",-940561982));
 ...
 */
com.fulcrologic.fulcro.algorithms.indexing.link_query_props = (function com$fulcrologic$fulcro$algorithms$indexing$link_query_props(p__61812){
var map__61813 = p__61812;
var map__61813__$1 = cljs.core.__destructure_map(map__61813);
var ast = map__61813__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61813__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61813__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
}),null)),null,-1037088993,null);

var map__61829 = app;
var map__61829__$1 = cljs.core.__destructure_map(map__61829);
var state_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61829__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","state-atom","com.fulcrologic.fulcro.application/state-atom",648128366));
...
var map__61830 = cljs.core.deref(runtime_atom);
var map__61830__$1 = cljs.core.__destructure_map(map__61830);
var root_class = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61830__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","root-class","com.fulcrologic.fulcro.application/root-class",-719803119));
...
var map__61868 = com.fulcrologic.fulcro.raw.components.any__GT_app(this$);
var map__61868__$1 = cljs.core.__destructure_map(map__61868);
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61868__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
...
if(cljs.core.truth_((function (){var and__4221__auto__ = ident;
...
var map__62101 = com.fulcrologic.fulcro.raw.components.any__GT_app(this$);
var map__62101__$1 = cljs.core.__destructure_map(map__62101);
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62101__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
var cls = com.fulcrologic.fulcro.raw.components.component_type(this$);
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"action","action",-811238024),(function com$fulcrologic$fulcro$algorithms$indexing$action(p__62109){
var map__62110 = p__62109;
var map__62110__$1 = cljs.core.__destructure_map(map__62110);
var app = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62110__$1,new cljs.core.Keyword(null,"app","app",-560961707));
var _STAR_after_render_STAR__orig_val__62111_62150 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__62112_62151 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__62112_62151);
...
}),null)),null,-1282555351,null);
}
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__62111_62150);
}
return null;
}),new cljs.core.Keyword(null,"result-action","result-action",-1254630246),(function (env){
var _STAR_after_render_STAR__orig_val__62116 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__62117 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__62117);
...
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__62116);
}})], null);
}));
