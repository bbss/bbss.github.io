...
function findNativeHandler(_ref){var start=_ref.start,current=_ref.current,anchor=_ref.anchor,JSCompiler_object_inline_scrollPosition_1519={x:"scrollLeft",y:"scrollTop"},JSCompiler_object_inline_scrollLength_1520={x:"scrollWidth",y:"scrollHeight"},JSCompiler_object_inline_clientLength_1521={x:"clientWidth",y:"clientHeight"};return _ref.domTreeShapes.some(function(shape){var goingForward=current>=start;if("top"===anchor||"left"===anchor)goingForward=!goingForward;var axis="left"===anchor||"right"===
anchor?"x":"y",scrollPosition=shape[JSCompiler_object_inline_scrollPosition_1519[axis]];axis=scrollPosition+shape[JSCompiler_object_inline_clientLength_1521[axis]]<shape[JSCompiler_object_inline_scrollLength_1520[axis]];return goingForward&&axis||!goingForward&&0<scrollPosition?shape:null})}var _interopRequireWildcard=require("module$node_modules$$babel$runtime$helpers$interopRequireWildcard"),_interopRequireDefault=require("module$node_modules$$babel$runtime$helpers$interopRequireDefault");Object.defineProperty(exports,
...
style:global.default.object}),SwipeAreaProps:global.default.object,swipeAreaWidth:global.default.number,transitionDuration:global.default.oneOfType([global.default.number,global.default.shape({enter:global.default.number,exit:global.default.number})]),variant:global.default.oneOf(["permanent","persistent","temporary"])};exports.default=require}
//# sourceMappingURL=module$node_modules$$material_ui$core$SwipeableDrawer$SwipeableDrawer.js.map
