...
rule;replaceRef||(replaceRef=getReplaceRef(container,sheet));isNested=isNested.replace(refRegExp,replaceRef);container.replaceRule(rule$jscomp$0.key+"-"+prop,style[prop],_extends__default["default"]({},options,{selector:isNested}))}else isNestedConditional&&container.addRule(prop,{},options).addRule(rule$jscomp$0.key,style[prop],{selector:rule$jscomp$0.selector});delete style[prop]}}return style}}}}
//# sourceMappingURL=module$node_modules$jss_plugin_nested$dist$jss_plugin_nested_cjs.js.map
