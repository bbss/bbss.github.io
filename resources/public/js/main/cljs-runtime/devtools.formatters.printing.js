...
var len__4829__auto___42260 = arguments.length;
var i__4830__auto___42261 = (0);
while(true){
if((i__4830__auto___42261 < len__4829__auto___42260)){
args__4835__auto__.push((arguments[i__4830__auto___42261]));

var G__42262 = (i__4830__auto___42261 + (1));
i__4830__auto___42261 = G__42262;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq42137){
...
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42138,G__42139,seq42137__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__42194_SHARP_){
return (!((cljs.core.meta(p1__42194_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42243__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e42244){var _e__40268__auto__ = e42244;
return false;
}})();
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
...
}catch (e42246){var _e__40268__auto__ = e42246;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__42251 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__42252 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__42252);

try{var map__42253 = opts;
var map__42253__$1 = cljs.core.__destructure_map(map__42253);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42253__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__42251);
}});
...
var temp__5751__auto___42274 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___42274)){
var managed_print_level_42275 = temp__5751__auto___42274;
var _STAR_print_level_STAR__orig_val__42255_42276 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__42256_42277 = managed_print_level_42275;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__42256_42277);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__42254_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__42254_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__42255_42276);
}} else {
job_fn();
}
