...
var G__42090 = (i__4830__auto___42087 + (1));
i__4830__auto___42087 = G__42090;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq41987){
...
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41988,G__41989,seq41987__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__42008_SHARP_){
return (!((cljs.core.meta(p1__42008_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42043__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e42045){var _e__40197__auto__ = e42045;
return false;
}})();
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
...
}catch (e42047){var _e__40197__auto__ = e42047;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__42055 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__42056 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__42056);

try{var map__42057 = opts;
var map__42057__$1 = cljs.core.__destructure_map(map__42057);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42057__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__42055);
}});
...
var temp__5751__auto___42143 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___42143)){
var managed_print_level_42144 = temp__5751__auto___42143;
var _STAR_print_level_STAR__orig_val__42063_42145 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__42064_42146 = managed_print_level_42144;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__42064_42146);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__42061_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__42061_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__42063_42145);
}} else {
job_fn();
}
