...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.max,(0),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49759_SHARP_){
return expound.printer.str_width(clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__49759_SHARP_,i))));
}),rows));
});
expound.printer.max_row_height = (function expound$printer$max_row_height(row){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.max,(0),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49778_SHARP_){
return cljs.core.count(clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__49778_SHARP_)));
}),row));
});
...
var G__49794 = ["%-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.nth.cljs$core$IFn$_invoke$arity$2(column_widths,i)),"s"].join('');
var G__49795 = v;
return (expound.printer.format.cljs$core$IFn$_invoke$arity$2 ? expound.printer.format.cljs$core$IFn$_invoke$arity$2(G__49794,G__49795) : expound.printer.format.call(null,G__49794,G__49795));
}),row);
}),multi_row);
}),multi_rows);
});
...
var columns_dividers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49803_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__49803_SHARP_)).length),"-"));
}),header);
var header_columns_dividers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49804_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__49804_SHARP_)).length),"="));
}),header);
...
var iter__4622__auto__ = (function expound$printer$multirow_$_iter__49826(s__49827){
return (new cljs.core.LazySeq(null,(function (){
var s__49827__$1 = s__49827;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__49827__$1);
if(temp__5753__auto__){
var s__49827__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__49827__$2)){
var c__4620__auto__ = cljs.core.chunk_first(s__49827__$2);
var size__4621__auto__ = cljs.core.count(c__4620__auto__);
var b__49829 = cljs.core.chunk_buffer(size__4621__auto__);
if((function (){var i__49828 = (0);
while(true){
if((i__49828 < size__4621__auto__)){
var row_idx = cljs.core._nth(c__4620__auto__,i__49828);
cljs.core.chunk_append(b__49829,(function (){var iter__4622__auto__ = ((function (i__49828,row_idx,c__4620__auto__,size__4621__auto__,b__49829,s__49827__$2,temp__5753__auto__,split_row_contents){
return (function expound$printer$multirow_$_iter__49826_$_iter__49834(s__49835){
return (new cljs.core.LazySeq(null,((function (i__49828,row_idx,c__4620__auto__,size__4621__auto__,b__49829,s__49827__$2,temp__5753__auto__,split_row_contents){
return (function (){
var s__49835__$1 = s__49835;
while(true){
var temp__5753__auto____$1 = cljs.core.seq(s__49835__$1);
if(temp__5753__auto____$1){
var s__49835__$2 = temp__5753__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__49835__$2)){
var c__4620__auto____$1 = cljs.core.chunk_first(s__49835__$2);
var size__4621__auto____$1 = cljs.core.count(c__4620__auto____$1);
var b__49837 = cljs.core.chunk_buffer(size__4621__auto____$1);
if((function (){var i__49836 = (0);
while(true){
if((i__49836 < size__4621__auto____$1)){
var col_idx = cljs.core._nth(c__4620__auto____$1,i__49836);
cljs.core.chunk_append(b__49837,cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""));

var G__50275 = (i__49836 + (1));
i__49836 = G__50275;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__49837),expound$printer$multirow_$_iter__49826_$_iter__49834(cljs.core.chunk_rest(s__49835__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__49837),null);
}
} else {
var col_idx = cljs.core.first(s__49835__$2);
return cljs.core.cons(cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""),expound$printer$multirow_$_iter__49826_$_iter__49834(cljs.core.rest(s__49835__$2)));
}
} else {
return null;
}
...
});})(i__49828,row_idx,c__4620__auto__,size__4621__auto__,b__49829,s__49827__$2,temp__5753__auto__,split_row_contents))
,null,null));
});})(i__49828,row_idx,c__4620__auto__,size__4621__auto__,b__49829,s__49827__$2,temp__5753__auto__,split_row_contents))
;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__49829),expound$printer$multirow_$_iter__49826(cljs.core.chunk_rest(s__49827__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__49829),null);
}
} else {
var row_idx = cljs.core.first(s__49827__$2);
return cljs.core.cons((function (){var iter__4622__auto__ = ((function (row_idx,s__49827__$2,temp__5753__auto__,split_row_contents){
return (function expound$printer$multirow_$_iter__49826_$_iter__49864(s__49865){
return (new cljs.core.LazySeq(null,(function (){
var s__49865__$1 = s__49865;
while(true){
var temp__5753__auto____$1 = cljs.core.seq(s__49865__$1);
if(temp__5753__auto____$1){
var s__49865__$2 = temp__5753__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__49865__$2)){
var c__4620__auto__ = cljs.core.chunk_first(s__49865__$2);
var size__4621__auto__ = cljs.core.count(c__4620__auto__);
var b__49867 = cljs.core.chunk_buffer(size__4621__auto__);
if((function (){var i__49866 = (0);
while(true){
if((i__49866 < size__4621__auto__)){
var col_idx = cljs.core._nth(c__4620__auto__,i__49866);
cljs.core.chunk_append(b__49867,cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""));

var G__50287 = (i__49866 + (1));
i__49866 = G__50287;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__49867),expound$printer$multirow_$_iter__49826_$_iter__49864(cljs.core.chunk_rest(s__49865__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__49867),null);
}
} else {
var col_idx = cljs.core.first(s__49865__$2);
return cljs.core.cons(cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""),expound$printer$multirow_$_iter__49826_$_iter__49864(cljs.core.rest(s__49865__$2)));
}
} else {
return null;
}
...
});})(row_idx,s__49827__$2,temp__5753__auto__,split_row_contents))
;
return iter__4622__auto__(cljs.core.range.cljs$core$IFn$_invoke$arity$1(cljs.core.count(row)));
})(),expound$printer$multirow_$_iter__49826(cljs.core.rest(s__49827__$2)));
}
} else {
return null;
}
...
var rows = cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [column_keys], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49877_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(p1__49877_SHARP_,column_keys);
}),map_rows));
...
var form = (function (){var G__49947 = via;
var G__49947__$1 = (((G__49947 == null))?null:cljs.core.last(G__49947));
if((G__49947__$1 == null)){
return null;
} else {
return cljs.spec.alpha.form(G__49947__$1);
}
})();
...
var seq__49957_50330 = cljs.core.seq(problems);
var chunk__49958_50331 = null;
var count__49959_50332 = (0);
var i__49960_50333 = (0);
while(true){
if((i__49960_50333 < count__49959_50332)){
var p_50334 = chunk__49958_50331.cljs$core$IIndexed$_nth$arity$2(null,i__49960_50333);
if((!((new cljs.core.Keyword("expound","via","expound/via",-595987777).cljs$core$IFn$_invoke$arity$1(p_50334) == null)))){
} else {
throw (new Error(["Assert failed: ",expound.util.assert_message,"\n","(some? (:expound/via p))"].join('')));
}


var G__50335 = seq__49957_50330;
var G__50336 = chunk__49958_50331;
var G__50337 = count__49959_50332;
var G__50338 = (i__49960_50333 + (1));
seq__49957_50330 = G__50335;
chunk__49958_50331 = G__50336;
count__49959_50332 = G__50337;
i__49960_50333 = G__50338;
continue;
} else {
var temp__5753__auto___50339 = cljs.core.seq(seq__49957_50330);
if(temp__5753__auto___50339){
var seq__49957_50340__$1 = temp__5753__auto___50339;
if(cljs.core.chunked_seq_QMARK_(seq__49957_50340__$1)){
var c__4649__auto___50341 = cljs.core.chunk_first(seq__49957_50340__$1);
var G__50342 = cljs.core.chunk_rest(seq__49957_50340__$1);
var G__50343 = c__4649__auto___50341;
var G__50344 = cljs.core.count(c__4649__auto___50341);
var G__50345 = (0);
seq__49957_50330 = G__50342;
chunk__49958_50331 = G__50343;
count__49959_50332 = G__50344;
i__49960_50333 = G__50345;
continue;
} else {
var p_50346 = cljs.core.first(seq__49957_50340__$1);
if((!((new cljs.core.Keyword("expound","via","expound/via",-595987777).cljs$core$IFn$_invoke$arity$1(p_50346) == null)))){
} else {
throw (new Error(["Assert failed: ",expound.util.assert_message,"\n","(some? (:expound/via p))"].join('')));
}


var G__50347 = cljs.core.next(seq__49957_50340__$1);
var G__50348 = null;
var G__50349 = (0);
var G__50350 = (0);
seq__49957_50330 = G__50347;
chunk__49958_50331 = G__50348;
count__49959_50332 = G__50349;
i__49960_50333 = G__50350;
continue;
}
} else {
}
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,k,((cljs.core.qualified_keyword_QMARK_(k))?k:(function (){var or__4223__auto__ = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__49953_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),cljs.core.name(p1__49953_SHARP_));
}),specs));
...
expound.printer.summarize_key_clause = (function expound$printer$summarize_key_clause(p__49991){
var vec__49993 = p__49991;
var branch = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49993,(0),null);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49993,(1),null);
var G__49996 = branch;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__49996__$1)].join('')));

}
});
expound.printer.missing_key = (function expound$printer$missing_key(form){
var vec__50001 = cljs.spec.alpha.conform(new cljs.core.Keyword("expound.spec","contains-key-pred","expound.spec/contains-key-pred",-989075236),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(form,(2)));
var branch = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50001,(0),null);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50001,(1),null);
var G__50004 = branch;
...
var len__4829__auto___50353 = arguments.length;
var i__4830__auto___50354 = (0);
while(true){
if((i__4830__auto___50354 < len__4829__auto___50353)){
args__4835__auto__.push((arguments[i__4830__auto___50354]));

var G__50355 = (i__4830__auto___50354 + (1));
i__4830__auto___50354 = G__50355;
continue;
} else {
}
break;
...
/** @this {Function} */
(expound.printer.format.cljs$lang$applyTo = (function (seq50041){
var G__50042 = cljs.core.first(seq50041);
var seq50041__$1 = cljs.core.next(seq50041);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50042,seq50041__$1);
}));
...
var keys = expound.printer.keywords(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50076_SHARP_){
return expound.printer.missing_key(new cljs.core.Keyword(null,"pred","pred",1927423397).cljs$core$IFn$_invoke$arity$1(p1__50076_SHARP_));
}),problems));
...
return cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2((function (p1__50077_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__50077_SHARP_,"key");
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__50081){
...
var _STAR_print_newline_STAR__orig_val__50107_50356 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__50108_50357 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__50109_50358 = true;
var _STAR_print_fn_STAR__temp_val__50110_50359 = (function (x__4761__auto__){
return sb__4760__auto__.append(x__4761__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__50109_50358);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__50110_50359);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__50108_50357);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__50107_50356);
}
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2(", ",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50113_SHARP_){
return expound.ansi.color.cljs$core$IFn$_invoke$arity$variadic(p1__50113_SHARP_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"correct-key","correct-key",1087492967)], 0));
...
var vec__50161 = clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(s));
var seq__50162 = cljs.core.seq(vec__50161);
var first__50163 = cljs.core.first(seq__50162);
var seq__50162__$1 = cljs.core.next(seq__50162);
var line = first__50163;
var lines = seq__50162__$1;
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [[cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(first_line_indent," "))),cljs.core.str.cljs$core$IFn$_invoke$arity$1(line)].join('')], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50145_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(rest_lines_indent," "))),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50145_SHARP_)].join('');
}),lines)));
}));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(displayed_form,new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(k)),(function (){var G__50227 = show_valid_values_QMARK_;
var G__50228 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(k);
var G__50229 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__50227,G__50228,G__50229) : expound.printer.summary_form.call(null,G__50227,G__50228,G__50229));
})(),new cljs.core.Keyword("expound.problems","irrelevant","expound.problems/irrelevant",2090226124));
} else {
if(((cljs.core.map_QMARK_(form)) && (expound.paths.kvps_QMARK_(k)))){
var G__50362 = show_valid_values_QMARK_;
var G__50363 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(k));
var G__50364 = rst__$1;
show_valid_values_QMARK_ = G__50362;
form = G__50363;
in$ = G__50364;
continue;
} else {
if(cljs.core.associative_QMARK_(form)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(displayed_form,k,(function (){var G__50232 = show_valid_values_QMARK_;
var G__50233 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(form,k);
var G__50234 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__50232,G__50233,G__50234) : expound.printer.summary_form.call(null,G__50232,G__50233,G__50234));
})());
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.seq_QMARK_(form)))){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__50236 = show_valid_values_QMARK_;
var G__50237 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(form,k);
var G__50238 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__50236,G__50237,G__50238) : expound.printer.summary_form.call(null,G__50236,G__50237,G__50238));
})()));
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.set_QMARK_(form)))){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.EMPTY,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__50239 = show_valid_values_QMARK_;
var G__50240 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),k);
var G__50241 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__50239,G__50240,G__50241) : expound.printer.summary_form.call(null,G__50239,G__50240,G__50241));
})()));
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.list_QMARK_(form)))){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.List.EMPTY,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__50242 = show_valid_values_QMARK_;
var G__50243 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),k);
var G__50244 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__50242,G__50243,G__50244) : expound.printer.summary_form.call(null,G__50242,G__50243,G__50244));
})()));
} else {
...
var max_width = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.max,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50246_SHARP_){
return ((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50246_SHARP_)).length);
...
var map__50249 = problem;
var map__50249__$1 = cljs.core.__destructure_map(map__50249);
var form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50249__$1,new cljs.core.Keyword("expound","form","expound/form",-264680632));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50249__$1,new cljs.core.Keyword("expound","in","expound/in",-1900412298));
var map__50250 = opts;
var map__50250__$1 = cljs.core.__destructure_map(map__50250);
var show_valid_values_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__50250__$1,new cljs.core.Keyword(null,"show-valid-values?","show-valid-values?",-587258094),false);
...
var s = (function (){var _STAR_print_namespace_maps_STAR__orig_val__50255 = cljs.core._STAR_print_namespace_maps_STAR_;
var _STAR_print_namespace_maps_STAR__temp_val__50256 = false;
(cljs.core._STAR_print_namespace_maps_STAR_ = _STAR_print_namespace_maps_STAR__temp_val__50256);
...
}finally {(cljs.core._STAR_print_namespace_maps_STAR_ = _STAR_print_namespace_maps_STAR__orig_val__50255);
}})();
var vec__50251 = cljs.core.re_find(regex,s);
...
var line = first__50253;
var first__50253__$1 = cljs.core.first(seq__50252__$1);
var seq__50252__$2 = cljs.core.next(seq__50252__$1);
var prefix = first__50253__$1;
var _more = seq__50252__$2;
