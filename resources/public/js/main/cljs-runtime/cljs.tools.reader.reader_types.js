...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_43946 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_43946(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_43947 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_43947(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_43948 = (function (reader,ch){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_43948(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_43949 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_43949(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_43950 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_43950(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_43951 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_43951(reader);
}
});
...
var G__43996 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__43997 = s.append(c);
c = G__43996;
s = G__43997;
continue;
}
