...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_43944 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_43944(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_43945 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_43945(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_43946 = (function (reader,ch){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_43946(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_43947 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_43947(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_43948 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_43948(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_43949 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_43949(reader);
}
});
...
var G__43991 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__43992 = s.append(c);
c = G__43991;
s = G__43992;
continue;
}
